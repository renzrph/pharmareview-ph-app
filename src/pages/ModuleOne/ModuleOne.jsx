...
import questionsData from "../../assets/module1.json";
...
const ModuleOne = () => {
  ...
  //     try {
  //       const response = await fetch("/src/assets/module1.json");
  //       if (!response.ok) {
  ...
  return (
    <div className="container">
      ...
      <h2 className="module-title">Module 1: Pharmaceutical Chemistry</h2>
      {allQuestionsAnswered ? (
        <Result
