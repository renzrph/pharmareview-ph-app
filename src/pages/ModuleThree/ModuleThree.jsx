...
import questionsData from "../../assets/module3.json";
...
const ModuleThree = () => {
  ...
  //     try {
  //       const response = await fetch("/src/assets/module3.json");
  //       if (!response.ok) {
  ...
  return (
    <div className="container">
      ...
      <h2 className="module-title">Module 3: Practice of Pharmacy</h2>
      {allQuestionsAnswered ? (
        <Result
